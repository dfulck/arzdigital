                                    ...
                                    <td class="text-right">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <button class="dropdown-item " type="button"><a class="text-white" href="{{route('footers.edit',$footer)}}">ویرایش</a></button>
                                                <form action="{{route('footers.destroy',$footer)}}" method="post" >
                                                    @csrf
                                                    @method('DELETE')
