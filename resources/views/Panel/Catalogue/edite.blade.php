                        ...
                        <div class="card-body">
                            ...
                            <form action="{{route('catalogues.update',$catalogue)}}" enctype="multipart/form-data" method="post">
                                ...
                                <div class="form-group form-control">
                                    <label class="form-check-label mx-2" for="">برای نمایش این کاتالوگ در صفحه اصلی سایت لطفا وضعیت ان را اپدیت کنید </label>
                                    <input name="status" type="radio" @if($catalogue->status==1)
                                    checked
                                    @endif
                                    value="1"> فعال
                                    <input name="status" type="radio" @if($catalogue->status==0)
                                    checked
                                           @endif
                                           value="0">غیر فعال
                                </div>
