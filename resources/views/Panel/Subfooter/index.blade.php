                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            @foreach($subfooters as $subfooter)
                                <tr>
                                    <th scope="row">{{$subfooter->id}}</th>
                                    <td>{{$subfooter->title}}</td>
                                    <td>{{$subfooter->link}}</td>
                                    <td class="text-right">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <button class="dropdown-item " type="button"><a class="text-white" href="{{route('footers.edit',$subfooter)}}">ویرایش</a></button>
                                                <form action="{{route('footers.destroy',$subfooter)}}" method="post" >
                                                    @csrf
                                                    @method('DELETE')
